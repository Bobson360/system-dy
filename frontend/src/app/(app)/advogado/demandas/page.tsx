...
import { Search, Plus, FileText, RefreshCw, ChevronLeft, ChevronRight, Filter } from 'lucide-react'
...
interface Demand {
  ...
  status: string
  createdAt: string
  client: { user: { firstName: string; lastName: string; email: string } }
  aiAnalysis: { id: string; isPreliminary: boolean } | null
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center gap-4 py-20">
            ...
            <Link
              ...
              className="flex items-center gap-2 rounded-lg bg-gold-500 px-4 py-2 text-sm font-semibold text-navy-950 hover:bg-gold-400 transition-colors"
            >
              <Plus size={16} /> Criar primeira demanda
            </Link>
          </div>
        ) : (
          <>
